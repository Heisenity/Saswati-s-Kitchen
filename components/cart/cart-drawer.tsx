...
export function CartDrawer() {
      ...
      ? createPortal(
          <div className="fixed inset-0 z-[9999]">
            ...
            <aside
              ...
              className="fixed right-0 top-0 z-[10000] flex h-[100dvh] w-[92vw] max-w-[420px] flex-col overflow-hidden border-l border-[#eadfd3] bg-[#fffaf5]/95 shadow-2xl backdrop-blur-md"
            >
  ...
  return (
    <>
      <button
        type="button"
        className="relative inline-flex h-10 items-center rounded-full border border-border bg-card px-3 py-2 text-sm font-semibold shadow-sm sm:px-4"
